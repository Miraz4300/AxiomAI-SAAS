...
export function fetchUpdateUserInfo<T = any>(email: string, name: string, avatar: string, description: string, message?: string) {
  return post<T>({
    url: '/user-info',
    data: { email, name, avatar, description, message },
  })
}
