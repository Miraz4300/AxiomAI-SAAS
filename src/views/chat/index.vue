                  ...
                  <h1 class="text-4xl font-semibold text-center mt-6 sm:mt-[20vh] ml-auto mr-auto mb-10 sm:mb-16 flex gap-2 items-center justify-center">
                    ...
                    <div class="flex flex-col mb-8 md:mb-auto gap-3.5 flex-1">
                      <h2 class="flex gap-3 items-center m-auto text-lg font-normal md:flex-col md:gap-2">
                        ...
                        <button class="w-full bg-gray-50 dark:bg-white/5 p-3 rounded-md hover:bg-[#ACACB2] dark:hover:bg-[#3E3F4B]" @click="fillTextarea('Explain quantum computing in simple terms')">
                          "Explain quantum computing in simple terms" →
                        </button><button class="w-full bg-gray-50 dark:bg-white/5 p-3 rounded-md hover:bg-[#ACACB2] dark:hover:bg-[#3E3F4B]" @click="fillTextarea('Got any creative ideas for a 10 year old\'s birthday?')">
                          "Got any creative ideas for a 10 year old's birthday?" →
                        </button><button class="w-full bg-gray-50 dark:bg-white/5 p-3 rounded-md hover:bg-[#ACACB2] dark:hover:bg-[#3E3F4B]" @click="fillTextarea('How do I make an HTTP request in Javascript?')">
