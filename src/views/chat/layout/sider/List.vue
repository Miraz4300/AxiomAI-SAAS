      ...
      <div class="flex flex-col gap-2 text-sm">
        ...
        <template v-else>
          <div v-for="(item, index) of dataSources" :key="index">
            <a
              class="relative flex items-center gap-3 px-3 py-3 break-all border rounded-md cursor-pointer hover:bg-neutral-100 group dark:border-neutral-800 dark:hover:bg-[#232B36]"
              :class="isActive(item.uuid) && ['border-[var(--primary-color)]', 'bg-neutral-100', 'text-[var(--primary-color)]', 'dark:bg-[#232B36]', 'pr-14']"
